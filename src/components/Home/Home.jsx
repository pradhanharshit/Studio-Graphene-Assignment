...
import jessica from "../../assets/jessica-radanavong-IchPBHFD0pw-unsplash.png";
  ...
  return (
    <div className="home-container">
      ...
      <div className="msg-container">
        <p className="msg">Fresh</p> <br />
        <p className="msg msg-2">2022</p> <br />
        <p className="msg msg-3">Look</p>
      </div>
      <div className="orng-rec"></div>
      <div className="model-img">
        <img src={jessica} alt="model-img" />
      </div>
      <div className="model-info">
        <p>OREGON JACKET</p>
        <p>$124</p>
      </div>
      <img className="star-3" src={star3} alt="" srcset="" />
      <img className="line-23" src={line23} alt="" srcset="" />
      <img className="star-4" src={star4} alt="" srcset="" />
      <div className="see-more">
        <span style={{ marginRight: "5px" }}>See More</span>
        <svg
          width="10"
          height="10"
          viewBox="0 0 10 10"
